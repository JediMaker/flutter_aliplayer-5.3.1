...
typedef OnCurrentDownloadSpeed = void Function(double netSpeed);
...
class FlutterAliplayer {
  ...
  OnCurrentDownloadSpeed onCurrentDownloadSpeed;
  ...
  void setOnCurrentDownloadSpeed(OnCurrentDownloadSpeed onCurrentDownloadSpeed) {
    this.onCurrentDownloadSpeed = onCurrentDownloadSpeed;
  }
